...
function bbcode2html_sososmilies(sososmilieid, getsrc) {
	...
	if(sososmilieid.indexOf('_') >= 0) {
		...
		imgsrc = "//imgstore0"+serverid+".cdn.sogou.com/app/a/100520032/"+realsmilieid;
	} else {
		var imgid = 'soso_' + sososmilieid;
		imgsrc = "//imgstore01.cdn.sogou.com/app/a/100520032/"+sososmilieid;
	}
...
function sososmiliesurl2id(sosourl) {
	var sososmilieid = '';
	if(sosourl && sosourl.length > 30 && sosourl.indexOf('//imgstore0') == 0) {
